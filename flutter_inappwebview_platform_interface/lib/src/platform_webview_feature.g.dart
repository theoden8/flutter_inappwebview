...
class AndroidWebViewFeature {
  ...
  ///
  static const FORCE_DARK = AndroidWebViewFeature._internal(
    'FORCE_DARK',
    'FORCE_DARK',
  );
  ...
  ///
  static const MULTI_PROCESS = AndroidWebViewFeature._internal(
    'MULTI_PROCESS',
    'MULTI_PROCESS',
  );
  ...
  ///
  static const PROXY_OVERRIDE = AndroidWebViewFeature._internal(
    'PROXY_OVERRIDE',
    'PROXY_OVERRIDE',
  );
  ...
  ///
  static const SAFE_BROWSING_HIT = AndroidWebViewFeature._internal(
    'SAFE_BROWSING_HIT',
    'SAFE_BROWSING_HIT',
  );
