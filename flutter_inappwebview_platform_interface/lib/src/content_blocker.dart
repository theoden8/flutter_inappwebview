...
class ContentBlockerTrigger {
  ...
  static ContentBlockerTrigger fromMap(
    ...
    return ContentBlockerTrigger(
      ...
      // Default to false when the key is absent. The
      // WKContentRuleList JSON shape treats this as an optional
      // boolean defaulting to false; adblock-rust's
      // `into_content_blocking()` exporter omits the key when it
      // would be false, so reading it raw threw
